  ...
  export default function EventsTable() {
    return (
      <div className="tierTable border border-[#DEDEDE] rounded-lg overflow-hidden">
        ...
        >
          <TableHeader>
            <TableColumn className="!rounded-bl-none pl-3">Event / Occasion</TableColumn>
            <TableColumn>Date of Event</TableColumn>
            <TableColumn>Points</TableColumn>
            <TableColumn>Status</TableColumn>
            <TableColumn className="!rounded-br-none" align="end">Action</TableColumn>
          </TableHeader>
              ...
              <TableCell>
                <div className="flex justify-end gap-4 text-gray-500">
                  <Tooltip showArrow={true} closeDelay={0} content="Edit">
                    <SquarePen size={14} className="cursor-pointer hover:text-black" />
                  </Tooltip>
