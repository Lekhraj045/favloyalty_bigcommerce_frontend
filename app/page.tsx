      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col gap-4">
          <div className="head">
            ...
            {(() => {
              // Example config for each step (replace stepXCompleted and stepXActive with actual values from state/props)
              const steps = [
                {
                  label: "Points & Tier System",
                  completed: true, // is this step done?
                  active: true, // is this step active?
                },
                {
                  label: "Ways to Earn",
                  completed: false,
              ...
              // update step configs with your values
                ...
                <div className="flex gap-3 mt-4 justify-between">
                  <div className="flex gap-3">
                    {steps.map((step, idx) => (
                      <button
                        key={step.label}
                        className={`${step.active ? "custom-btn" : "custom-btn-default"} flex items-center gap-2 cursor-pointer`}
                      >
                        {step.label}
                        {step.completed ? (
                          <CircleCheck size={16} />
